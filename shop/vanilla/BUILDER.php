...
if (isset($_POST['submit'])) {
    ...
    if (!empty($_POST['name']) ) {
        ...
        $m_amount   = number_format(79,   2, '.', ''); // сумма счета с двумя знаками после точки
...
<div class="intro">
    ...
    <div class="container">
        <h2 class="intro__title">Builder</h2>
        <div class="intro__inner">
            <div class="img_buy">
                <img src="../../images\items\builder.png" width="300" height="300">
                <form method="post" action="">
                    <input class="field__nick" type="text" placeholder=" Ник" name="name">
                    <p><input class="button__submit" type="submit" name="submit" value="Купить за 79р."></p>

                </form>
            </div>
            <div class="desc">
            <h1 class="description">Кол-во приватов - 6 </h1>
