...
if (isset($_POST['submit'])) {
    ...
    if (!empty($_POST['name']) ) {
        ...
        $m_amount   = number_format(59,   2, '.', ''); // сумма счета с двумя знаками после точки
...
<div class="intro">
    ...
    <div class="container">
        <h2 class="intro__title">MVP</h2>
        <div class="intro__inner">
            <div class="img_buy">
                <img src="../../images\items\mvp.png" width="300" height="300">
                <form method="post" action="">
                    <input class="field__nick" type="text" placeholder=" Ник" name="name">
                    <p><input class="button__submit" type="submit" name="submit" value="Купить за 59р."></p>
                    ...
                    <div class="desc">
                        <h1 class="description">Кол-во приватов - 4 </h1>
                        <h1 class="description">Размеры приватов (объем блоков):1632000</h1>
                        <h1 class="description">Количество домов /sethome: 4</h1>
                        <h1 class="description">Число публичных варпов: 2</h1>
                        ...
                        <h1 class="description">Наборы предметов: MVP</h1>
                    </div>
