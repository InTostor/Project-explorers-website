...
if (isset($_POST['submit'])) {
    ...
    if (!empty($_POST['name']) ) {
        ...
        $m_amount   = number_format(299,   2, '.', ''); // сумма счета с двумя знаками после точки
...
<div class="intro">
    ...
    <div class="container">
        ...
        <div class="img_buy">
                <img src="../../images\items\premium.png" width="300" height="300">
                <form method="post" action="">
                    <input class="field__nick" type="text" placeholder=" Ник" name="name">
                    <p><input class="button__submit" type="submit" name="submit" value="Купить за 299р."></p>

                </form>
            </div>
            <div class="desc">
                    <h1 class="description">Кол-во приватов - 7 </h1>
                    ...
                    <h1 class="description">Наборы предметов: Premium</h1>
                </div>
            </p>
        </div>
    </div>
