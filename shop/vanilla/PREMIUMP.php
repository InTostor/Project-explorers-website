...
if (isset($_POST['submit'])) {
    ...
    if (!empty($_POST['name']) ) {
        ...
        $m_amount   = number_format(599,   2, '.', ''); // сумма счета с двумя знаками после точки
...
<div class="intro">
    ...
    <div class="container">
        <h2 class="intro__title">Premium+</h2>
        <div class="intro__inner">
            <div class="img_buy">
                <img src="../../images\items\premiumP.png" width="300" height="300">
                <form method="post" action="">
                    <input class="field__nick" type="text" placeholder=" Ник" name="name">
                    <p><input class="button__submit" type="submit" name="submit" value="Купить за 599р."></p>

                </form>
            </div>
            <div class="desc">
                <h1 class="description">Кол-во приватов - 12 </h1>
                <h1 class="description">Размеры приватов (объем блоков):1632000</h1>
                <h1 class="description">Количество домов /sethome: 10</h1>
                <h1 class="description">Число публичных варпов: 8</h1>
                <h1 class="description">Восстановление инвентаря после смерти: Да</h1>
                <h1 class="description">Восстановление опыта после смерти: Да</h1>
                <h1 class="description">Приватные слоты на сервере: Да</h1>
                <h1 class="description">Смена префикса и его цвета: Да</h1>
                ...
                <h1 class="description">Починка инструментов и оружия - /repair: Да</h1>
                <h1 class="description">Надеть предмет на голову - /hat: Да</h1>
                <h1 class="description">Вернуться на предыдущую позицию - /back: Да</h1>
                ...
                <h1 class="description">Полёт - /fly: Да</h1>
                <h1 class="description">Пополнить сытость - /feed: Да</h1>
                <h1 class="description">Пополнить здоровье и сытость - /heal: Да</h1>
                <h1 class="description">Режим бога - /god: Да</h1>
                <h1 class="description">Посмотреть когда игрок был онлайн - /seen: Да</h1>
                <h1 class="description">Наборы предметов: Builder, Premium, Premium+</h1>
            </div>
        </div>
    </div>
</div>
