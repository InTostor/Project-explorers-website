...
if (isset($_POST['submit'])) {
    ...
    if (!empty($_POST['name']) ) {
        ...
        $m_amount   = number_format(29,   2, '.', ''); // сумма счета с двумя знаками после точки
        ...
        <div class="intro">
            ...
            <div class="container">
                ...
                <div class="intro__inner">
                    <div class="img_buy">
                        <img src="../../images\items\vipP.png" width="300" height="300">
                        <form method="post" action="">
                            <input class="field__nick" type="text" placeholder=" Ник" name="name">
                            <p><input class="button__submit" type="submit" name="submit" value="Купить за 29р."></p>
                ...
                <h1 class="description">Сменить время для себя - /ptime: Нет</h1>
